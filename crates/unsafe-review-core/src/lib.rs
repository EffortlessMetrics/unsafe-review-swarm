...
pub use api::{
    ...
    evaluate_policy_report_from_output, explain_card, project_editor, render_badge_jsons,
...
pub use candidate::{
    ...
    ManualCandidateLocation, load_manual_candidate, load_manual_candidates,
    manual_candidate_implementer_handoff, manual_candidate_path, read_manual_candidate,
