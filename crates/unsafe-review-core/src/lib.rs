...
pub use api::{
    ...
    render_badge_jsons, render_comment_plan, render_fixture_surface,
    render_fixture_surface_from_workspace, render_gate_manifest, render_gate_manifest_repo,
    render_github_summary, render_human, render_json, render_json_with_provenance, render_lsp,
    render_lsp_hover, render_markdown, render_outcome_json, render_outcome_markdown,
