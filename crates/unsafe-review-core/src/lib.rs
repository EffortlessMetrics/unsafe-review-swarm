...
pub use api::{
    ...
    bless_fixture_surface_goldens, collect_context, collect_context_range, compare_outcome_json,
    ...
    render_fixture_surface, render_gate_manifest, render_gate_manifest_repo, render_github_summary,
    render_human, render_json, render_json_with_provenance, render_lsp, render_lsp_hover,
