...
pub use api::{
    ...
    RepoScanEvent, RepoScanPhase, RepoScanStatus, RepoStopReason, ScanCost, Scope, analyze,
    ...
    project_editor, project_editor_diagnostics, render_badge_jsons, render_baseline_refresh_human,
    render_baseline_refresh_json, render_baseline_status_human, render_baseline_status_json,
    render_comment_plan, render_fixture_surface, render_fixture_surface_from_workspace,
