...
pub use receipt::{
    ...
    ProofReceiptInput, ReceiptCardIdKind, SanitizerReceiptInput, SubjectApplicability,
    SubjectBinding, TerminalStatus, WITNESS_RECEIPT_SCHEMA_VERSION, WitnessReceipt,
};
