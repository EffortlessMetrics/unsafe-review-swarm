...
pub(crate) fn scan_file(
    ...
    let syntax_operation_lines = syntax_projection::syntax_operation_lines(&syntax_sites);
    let syntax_operation_block_lines = operation_block_start_lines(&parsed);
    let mut seen = BTreeSet::new();

    let mut out = fallback_scan::scan_text_fallback_sites(
        rel,
        diff,
        repo_mode,
        &lines,
    ...
    out.extend(syntax_projection::scan_syntax_sites(
        rel,
        diff,
        repo_mode,
        &lines,
