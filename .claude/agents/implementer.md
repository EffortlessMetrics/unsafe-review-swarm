...
- Read the controlling stack before editing: `.allow/goals/active.toml` → cargo-allow worklist → lane plan → spec. If the brief names a command, lint, API, or flag — verify it exists before building around it.
