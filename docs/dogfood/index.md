...
| `smol-rs/async-task` | 1 | 0 | `RawWaker`, unsafe function pointer fields, `Pin::new_unchecked`, `NonNull`, drop/deallocation, raw pointer task state, and unsafe Send/Sync cards |
