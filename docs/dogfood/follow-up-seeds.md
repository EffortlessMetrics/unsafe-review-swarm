...
| `dogfood-bun-manual-candidates-first-pr-smoke` | `done` | `bun-manual-candidates-first-pr-smoke` | `manual_candidate_projection` | `actionable` | [Bun manual candidates first-pr smoke](reports/2026-06-03-bun-manual-candidates-first-pr-smoke.md) | `manual-candidates: keep Bun example smoke projection-backed` | Current follow-up is covered by the manual-candidate example verifier, manual repair queue sidecar verifier, and dogfood report; keep it as regression pressure for Bun manual-candidate projection surfaces. |
