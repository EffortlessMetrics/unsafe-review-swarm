...
| Handoff | Date | Scope |
|---|---|---|
| [Source badge plus count sync](2026-06-01-source-badge-plus-count-sync.md) | 2026-06-01 | mirrors source PR #512 public `unsafe-review+` Shields endpoint semantics and updates the source-sync checkpoint without claiming publication, proof, or policy readiness |
