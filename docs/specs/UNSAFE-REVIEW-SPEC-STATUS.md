...
| `UNSAFE-REVIEW-SPEC-0025` docs automation | proposed | Policy ledger rail defined; checker/generator implementation pending | `cargo run --locked -p xtask -- check-doc-artifacts`; `cargo run --locked -p xtask -- check-goals`; `cargo run --locked -p xtask -- check-pr` | 2026-05-21 | Establishes machine-checkable docs automation control-plane boundaries before new generators land |
