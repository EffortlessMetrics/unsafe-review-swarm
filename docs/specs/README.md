...
24. [Accuracy validation and calibration](UNSAFE-REVIEW-SPEC-0026-accuracy-validation-and-calibration.md)


## Appendices

- [Operation-family registry appendix](appendices/UNSAFE-REVIEW-SPEC-0005-appendix-operation-family-registry.md)
