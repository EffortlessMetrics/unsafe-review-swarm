...
ADRs record durable architecture choices.

## Index

- [ADR 0001: Stable-first source analysis](UNSAFE-REVIEW-ADR-0001-stable-first-source-analysis.md)
- [ADR 0002: ReviewCard is canonical](UNSAFE-REVIEW-ADR-0002-review-card-is-canonical.md)
