...
fixture-pinned claims, 482 calibration cases, 34 label ledgers, and 495 label
...
evidence for `assume_init`, `assume_init_read`, and `assume_init_ref` while rejecting other-slot writes for `assume_init`,
