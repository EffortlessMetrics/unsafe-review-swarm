...
fixture-pinned claims, 486 calibration cases, 34 label ledgers, and 499 label
...
`write` evidence for `assume_init`, `assume_init_read`, and
`assume_init_ref`, same-slot `MaybeUninit::new` initialization evidence for
