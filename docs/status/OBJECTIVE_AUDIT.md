...
fixture-pinned claims, 462 calibration cases, 34 label ledgers, and 475 label
...
`assume_init`, `assume_init_read`, and `assume_init_ref`, and stale writes for
`assume_init`, `assume_init_read`, `assume_init_ref`,
