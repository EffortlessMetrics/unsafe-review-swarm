...
`docs/accuracy/CALIBRATION_REPORT.md`. The checked report currently records 43 fixture-pinned claims, 627 calibration cases, 43 label ledgers, and 599 label samples. It records zero dogfood-measured, labeled-calibrated, or
