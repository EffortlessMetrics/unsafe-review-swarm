...
fixture-pinned claims, 485 calibration cases, 34 label ledgers, and 498 label
...
`write` evidence for `assume_init` and `assume_init_read`, same-slot
`MaybeUninit::new` initialization evidence for
