...
fixture-pinned claims, 478 calibration cases, 34 label ledgers, and 491 label
...
`assume_init`, `assume_init_read`, and `assume_init_ref`, and open-branch `MaybeUninit::new`
