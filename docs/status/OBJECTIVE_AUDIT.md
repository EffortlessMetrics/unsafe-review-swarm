...
fixture-pinned claims, 481 calibration cases, 34 label ledgers, and 494 label
...
evidence for `assume_init` and `assume_init_read` while rejecting other-slot writes for `assume_init`,
