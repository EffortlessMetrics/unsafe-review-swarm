...
fixture-pinned claims, 483 calibration cases, 34 label ledgers, and 496 label
...
evidence for `assume_init`, `assume_init_read`, `assume_init_ref`, and
`assume_init_mut` while rejecting other-slot writes for `assume_init`,
