...
fixture-pinned claims, 471 calibration cases, 34 label ledgers, and 484 label
...
`assume_init_read`, `assume_init_ref`, and `assume_init_mut`, closed conditional
`MaybeUninit::new` evidence for `assume_init`,
