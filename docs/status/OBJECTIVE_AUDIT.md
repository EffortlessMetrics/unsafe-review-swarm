...
fixture-pinned claims, 455 calibration cases, 34 label ledgers, and 468 label
...
writes for `assume_init`, `assume_init_read`, `assume_init_ref`, and
`assume_init_mut` after reassignment.
