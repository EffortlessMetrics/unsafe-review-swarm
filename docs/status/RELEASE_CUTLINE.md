...
- Swarm base: `e5d7caaa10a660044c374d0582db073180dec59d`
  (`ux: deduplicate top-card reviewer action handoff (#2066)`)
...
- `source-divergence`: `new_source_commits=0`, `raw_swarm_only=245`; the swarm
...
| Action-first PR front door (#1884) | partial — changed-file scope, movement, comment-plan, selected-action, missing-base recovery, brownfield baseline, compact artifact handoff, minimal-repro cue, compact overview-count, and deduplicated top-card action slices are integrated; broader one-screen front-panel compression remains open |
