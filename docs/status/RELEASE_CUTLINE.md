...
- Swarm base: `da2c8b945b3a368ab7a0a701097c7a3f77c5ae1d`
  (`test: cover confirm timeout child reaping`)
...
- `source-divergence`: `new_source_commits=0`, `raw_swarm_only=240`; the swarm
...
| Action-first PR front door (#1884) | partial — changed-file scope, movement, comment-plan, selected-action, missing-base recovery, brownfield baseline, and compact artifact handoff slices are integrated; broader one-screen front-panel compression remains open |
