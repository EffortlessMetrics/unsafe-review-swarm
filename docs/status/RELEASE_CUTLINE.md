...
- Swarm base: `adec1af378548842064ff6b17577c2e43f6efed3`
  (`ux: make pr-setup routes copyable (#2072)`)
...
- `source-divergence`: `new_source_commits=0`, `raw_swarm_only=251`; the swarm
