/// Probe: a multiline ptr::copy call split across lines to exercise the
/// multiline shadow path.  The call opener (`ptr::copy(`) appears alone on its
/// line; the tool must not truncate the snippet to that opener.  Class and
/// obligations are identical to the single-line ptr_copy_overlapping fixture.
